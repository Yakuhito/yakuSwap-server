...
addCurrency('gdog', 'GreenDoge', 'https://raw.githubusercontent.com/GreenDoge-Network/greendoge-blockchain/main/greendoge-blockchain-gui/src/assets/img/greendoge_circle.png', 1000000000000, 1, 5000, 32, '127.0.0.1', 6655, guessSslDirFor("GreenDoge"))
...
addCurrency('cans', 'Cannabis', 'https://raw.githubusercontent.com/CannabisChain/cannabis-blockchain-gui/main/src/assets/img/cannabis_circle.png', 1000000000000, 1, 5000, 32, '127.0.0.1', 5540, guessSslDirFor("Cannabis"))
