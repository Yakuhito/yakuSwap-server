...
addCurrency('xch', 'Chia', 'https://raw.githubusercontent.com/Chia-Network/chia-blockchain-gui/main/src/assets/img/chia_circle.svg', 1000000000000, 1, 5000, 10, '127.0.0.1', 8555, guessSslDirFor("Chia"))
addCurrency('xfx', 'Flax', 'https://raw.githubusercontent.com/Flax-Network/flax-blockchain-gui/main/src/assets/img/flax_circle.svg', 1000000000000, 1, 5000, 25, '127.0.0.1', 6755, guessSslDirFor("Flax"))
...
addCurrency('hdd', 'HDDCoin', 'https://raw.githubusercontent.com/HDDcoin-Network/hddcoin-blockchain/main/hddcoin-blockchain-gui/src/assets/img/hddcoin_circle.svg', 1000000000000, 1, 5000, 32, '127.0.0.1', 28555, guessSslDirFor("HDDCoin"))
addCurrency('sit', 'Silicoin', 'https://raw.githubusercontent.com/silicoin-network/silicoin-blockchain-gui/main/src/assets/img/chia_circle.png', 1000000000000, 1, 5000, 32, '127.0.0.1', 10555, guessSslDirFor("Silicoin"))
addCurrency('xcd', 'Chiadogecoin', 'https://raw.githubusercontent.com/ChiaDoge-Network/chiadogecoin/main/chiadogecoin-gui/src/assets/img/chiadoge_circle.svg', 1000000000, 1, 5000, 32, '127.0.0.1', 6795, guessSslDirFor("Chiadoge"))
#addCurrency('gdog', 'GreenDoge', 'https://raw.githubusercontent.com/GreenDoge-Network/greendoge-blockchain/main/greendoge-blockchain-gui/src/assets/img/greendoge_circle.svg', 1000000000000, 1, 5000, 32, '127.0.0.1', 6655, guessSslDirFor("GreenDoge"))
addCurrency('avo', 'Avocado', 'https://raw.githubusercontent.com/Avocado-Network/avocado-blockchain-gui/main/src/assets/img/avocado_circle.png', 1000000000000, 1, 5000, 32, '127.0.0.1', 7544, guessSslDirFor("Avocado"))
addCurrency('xka', 'Kale', 'https://raw.githubusercontent.com/Kale-Network/kale-blockchain/main/kale-blockchain-gui/src/assets/img/kale_circle.svg', 1000000000000, 1, 5000, 32, '127.0.0.1', 6355, guessSslDirFor("Kale"))
addCurrency('xtx', 'Taco', 'https://raw.githubusercontent.com/Taco-Network/taco-blockchain/main/taco-blockchain-gui/src/assets/img/taco_circle.svg', 1000000000000, 1, 5000, 32, '127.0.0.1', 18735, guessSslDirFor("Taco"))
addCurrency('xeq', 'Equality', 'https://raw.githubusercontent.com/Equality-Network/equality-blockchain-gui/master/src/assets/img/equality_circle.png', 1000000000000, 1, 5000, 32, '127.0.0.1', 9547, guessSslDirFor("Equality"))
#addCurrency('sock', 'Socks', 'https://bitbucket.org/Socks-Network/socks-blockchain-gui/raw/aefb284f40a2ff521591d79702b478317581ce94/src/assets/img/socks_circle.svg', 1000000000000, 1, 5000, 32, '127.0.0.1', 58455, guessSslDirFor("Socks"))
#addCurrency('wheat', 'Wheat', 'https://raw.githubusercontent.com/wheatnetwork/wheat-blockchain-gui/main/src/assets/img/wheat_circle.svg', 1000000000000, 1, 5000, 32, '127.0.0.1', 21555, guessSslDirFor("Wheat"))
addCurrency('xmx', 'Melati', 'https://raw.githubusercontent.com/Melati-Network/melati-blockchain-gui/main/src/assets/img/melati_circle.svg', 1000000000000, 1, 5000, 32, '127.0.0.1', 2555, guessSslDirFor("Melati"))
addCurrency('tad', 'Tad', 'https://raw.githubusercontent.com/Tad-Network/tad-blockchain-gui/main/src/assets/img/tad_circle.png', 1000000000000, 1, 5000, 32, '127.0.0.1', 4555, guessSslDirFor("Tad"))
addCurrency('xsc', 'Sector', 'https://raw.githubusercontent.com/Sector-Network/sector-blockchain-gui/main/src/assets/img/sector_circle.svg', 1000000000000, 1, 5000, 32, '127.0.0.1', 5555, guessSslDirFor("Sector"))
addCurrency('cac', 'Cactus', 'https://raw.githubusercontent.com/Cactus-Network/cactus-blockchain/main/cactus-blockchain-gui/src/assets/img/cactus_circle.svg', 1000000000000, 1, 5000, 32, '127.0.0.1', 11555, guessSslDirFor("Cactus"))
#addCurrency('cans', 'Cannabis', 'https://raw.githubusercontent.com/CannabisChain/cannabis-blockchain-gui/main/src/assets/img/cannabis_circle.svg', 1000000000000, 1, 5000, 32, '127.0.0.1', 5540, guessSslDirFor("Cannabis"))
addCurrency('xmz', 'Maize', 'https://raw.githubusercontent.com/Maize-Network/maize-blockchain/main/maize-blockchain-gui/src/assets/img/chia_circle.svg', 1000000000000, 1, 5000, 32, '127.0.0.1', 8655, guessSslDirFor("Maize"))
